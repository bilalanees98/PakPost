...
<div class="footer">
	<form name = "funds" action = "trackingReport.php" method = "POST">
	<table>
		...
		<tr>
			<td>
			<a href="cnicTrackingForm.html">Click here if you don't remember your shipment id</a>
			</td>
		</tr>
		<tr>
			<td>
				<input type="submit" value="Track" name= "trackSubmit" id="trackSubmit">
			</td>
		</tr>
